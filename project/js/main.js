function handleSignIn() {
  var provider = new firebaseui.auth.GoogleAuthProvider();

  firebaseui.auth().signInWithPopup(provider).then(function(result) {
    var token = result.credential.accessToken;
    var user = result.credential.accessToken;
